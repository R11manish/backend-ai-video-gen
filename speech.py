...
class SpeechGenerator:
    ...
    def generate_speech(self, text, voice_id="Joanna", output_format="mp3", output_path="/tmp/audio"):
    ...
    async def generate_speech_async(self, text, voice_id="Joanna", output_format="mp3", output_path="/tmp/audio"):
        import asyncio
